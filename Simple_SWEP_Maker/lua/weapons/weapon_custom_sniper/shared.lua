...
if CLIENT then
    SWEP.PrintName = "Custom Sniper"
    SWEP.Author = "Simple Simpleton"
    SWEP.Slot = 0
    SWEP.SlotPos = 0
    SWEP.IconLetter = "n"

    killicon.AddFont("weapon_custom_sniper", "CSKillIcons", SWEP.IconLetter, Color(200, 200, 200, 255))
end

DEFINE_BASECLASS("weapon_simple_base")

SWEP.Spawnable = true
SWEP.AdminOnly = false
SWEP.Category = "Simple Weapons"
