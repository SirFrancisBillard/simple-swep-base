...
if CLIENT then
	SWEP.PrintName = "The Clipper" --The fancy name of your SWEP
	SWEP.Author = "Sir Francis Billard" --Who made this SWEP
	...
	SWEP.IconLetter = "w" --The letter code of the kill icon. Full list of icons can be found here (for CSS): https://wiki.garrysmod.com/page/CS:S_Kill_Icons

	killicon.AddFont("weapon_clipper_deagle", "CSKillIcons", SWEP.IconLetter, Color(255, 80, 0, 255)) --Make sure that first one is the name of your SWEP
end
...
SWEP.ViewModel = "models/weapons/cstrike/c_rif_m4a1.mdl" --The model you see when you hold it
SWEP.WorldModel = "models/weapons/w_rif_m4a1_silencer.mdl" --The model other players see when you hold it
...
SWEP.Primary.Sound = Sound("weapons/m4a1/m4a1-1.wav") --The sound made when the gun shoots
SWEP.Primary.Recoil = 0.2 --How much kick the gun has upon firing
SWEP.Primary.Damage = 140 --Base damage this weapon deals
...
SWEP.Primary.Delay = 0.4 --The delay in seconds between each shot
SWEP.Primary.DefaultClip = 21 --The amount of spare ammo you get for picking this gun up
