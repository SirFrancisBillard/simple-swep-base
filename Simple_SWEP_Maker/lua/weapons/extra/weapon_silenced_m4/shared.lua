...
if CLIENT then
	SWEP.PrintName = "Silenced M4" --The fancy name of your SWEP
	SWEP.Author = "Sir Francis Billard" --Who made this SWEP
	SWEP.Slot = 2 --What slot on the hotbar it is in
	...
	killicon.AddFont("weapon_silenced_m4", "CSKillIcons", SWEP.IconLetter, Color(255, 80, 0, 255)) --Make sure that first one is the name of your SWEP
end
...
SWEP.Primary.Recoil = 1 --How much kick the gun has upon firing
...
SWEP.Primary.Delay = 0.5 --The delay in seconds between each shot
